...
export function ThemeToggleCompact() {
  ...
  return (
    <button
      onClick={cycle}
      className="flex h-7 w-7 items-center justify-center rounded-md border border-b-secondary text-t-secondary transition-colors hover:bg-input-bg hover:text-t-primary [&_svg]:relative [&_svg]:top-px"
      title={`Theme: ${theme}`}
    >
      {theme === "dark" ? (
        <MoonIcon />
