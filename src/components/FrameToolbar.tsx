...
export function FrameToolbar({
  ...
  return (
    <div
      className="absolute left-1/2 flex -translate-x-1/2 items-center gap-2 rounded-md border border-b-secondary bg-canvas-panel-bg/95 px-2 py-1 shadow-sm backdrop-blur-sm"
      style={{
