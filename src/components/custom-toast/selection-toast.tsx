...
export function SelectionToast({
  ...
  return (
    <div className="flex w-[550px] max-w-[calc(100vw-32px)] items-center justify-between gap-2 rounded-xl border border-b-0 border-b-primary bg-surface-elevated p-2 shadow-lg duration-300 dark:border-transparent dark:bg-canvas-panel dark:shadow-none">
