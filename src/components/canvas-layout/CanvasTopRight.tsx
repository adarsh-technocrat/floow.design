...
export function CanvasTopRight() {
  return (
    <div className="absolute right-0 top-0 z-10 flex h-12 items-center gap-1 px-4">
      ...
      <button
        type="button"
        className="inline-flex size-8 items-center justify-center rounded-full border border-b-secondary text-t-secondary transition-colors hover:bg-input-bg hover:text-t-primary"
