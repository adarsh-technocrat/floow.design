...
export default function FrameElementToolbar({
  ...
  const toolbarContent = (
    <div className="flex w-max items-center gap-1.5 rounded-xl border border-b-secondary bg-canvas-panel-bg/95 p-1.5 shadow-lg backdrop-blur-sm">
      {isText && (
        <>
          <button
            type="button"
          ...
          {onSetFontFamily && (
            <select
              ...
              className="h-8 min-w-[90px] max-w-[120px] rounded-md border border-b-secondary bg-input-bg px-2 text-xs text-t-primary focus:outline-none focus:ring-2 focus:ring-[#8A87F8]"
              style={{ fontFamily }}
              title="Font"
            >
          ...
          {onSetColor && (
            <div className="flex items-center gap-1">
              <input
                ...
                className="h-8 w-8 cursor-pointer rounded border border-b-secondary bg-transparent"
                title="Text color"
              />
            </div>
          )}
          {onSetFontSize && (
            <div className="flex h-8 items-center overflow-hidden rounded-md border border-b-secondary bg-input-bg">
              <button
                type="button"
              ...
              <input
                ...
                className="h-full w-10 border-x border-y-0 bg-transparent text-center text-xs text-t-primary [border-color:var(--border-secondary)] [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
              />
              <button
                type="button"
                className="flex h-full w-7 items-center justify-center text-t-secondary hover:bg-surface-sunken hover:text-t-primary"
        ...
        <div className="min-w-[260px] max-h-[220px] overflow-y-auto rounded-xl border border-b-secondary bg-canvas-panel-bg/95 p-2.5 shadow-lg backdrop-blur-sm">
          ...
          <div className="mb-2 flex items-center gap-1.5">
            <input
              ...
              className="h-8 flex-1 rounded-md border border-b-secondary bg-input-bg px-2.5 text-xs text-t-primary placeholder:text-t-tertiary focus:outline-none focus:ring-2 focus:ring-[#8A87F8]"
            />
            <button
              type="button"
