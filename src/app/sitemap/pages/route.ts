...
const staticPages = [
  ...
  { path: "/features/export-to-figma", changefreq: "weekly", priority: "0.8" },
  {
  ...
  { path: "/compare/floow-vs-uizard", changefreq: "monthly", priority: "0.7" },
  { path: "/compare/floow-vs-figma", changefreq: "monthly", priority: "0.7" },
  { path: "/compare/floow-vs-visily", changefreq: "monthly", priority: "0.7" },
  {
